...
COMMENT ON COLUMN "profiles".message_retention_enabled IS 'Enable message retention for this user';
COMMENT ON COLUMN "profiles".message_retention_days IS 'Retention window in days';
