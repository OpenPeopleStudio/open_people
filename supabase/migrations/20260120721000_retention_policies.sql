...
-- Drop existing tables if they exist with wrong schema (from partial migration)
DROP TABLE IF EXISTS retention_executions CASCADE;
...
DROP FUNCTION IF EXISTS execute_all_retention_policies();
