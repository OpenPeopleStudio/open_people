...
Each task must have: owner, scope, files, and definition of done.
...
- Add a short “How to claim/release locks” note to docs/company/locks.md.
- Add a one‑pager: “API readiness checklist” in docs/company/.
