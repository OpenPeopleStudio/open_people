...
| Cursor | 2026-09-22 | lib/og/copy.ts, lib/voice-mode/anchors.ts, app/(marketing)/page.tsx, __tests__/unit/lib/og/desk-og.test.ts, __tests__/unit/lib/voice-mode/parse.test.ts | exclusive | 2026-09-23 | active | Copy pass 1: meta + Dual plain (Hogan: What matters is) |
