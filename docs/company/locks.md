...
| Cursor | 2026-09-22 | app/layout.tsx, lib/og/metadata.ts, lib/og/copy.ts, __tests__/unit/lib/og/desk-og.test.ts | exclusive | 2026-09-23 | active | Explicit og:image / twitter:image in metadata so Next cannot drop the card |
